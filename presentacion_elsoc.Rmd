...
Un modelo marginal especifica directamente la media marginal de $y_{ij}$

$$\text{logit}(Ey_{ij})=\text{logit}(P(y_{ij}=1))=\beta_0+\beta_1x_{ij}$$
Mediante el uso de una **.morado[quasi-verosimilitud]** permite especificar una matriz de covarianza de trabajo que explica la estructura de correlación para las mediciones de una misma persona.
